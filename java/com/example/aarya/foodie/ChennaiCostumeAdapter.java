...
class ChennaiCustomeAdapter  extends BaseAdapter {

    private Context context;
    private ArrayList<ChennaiImageModel> imageModelArrayList;


    public ChennaiCustomeAdapter(Context context, ArrayList<ChennaiImageModel> imageModelArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.chennai_iv_model, null, true);
