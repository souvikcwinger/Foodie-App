...
class BangloreCustomeAdapter  extends BaseAdapter {

    private Context context;
    private ArrayList<BangloreImageModel> imageModelArrayList;


    public BangloreCustomeAdapter(Context context, ArrayList<BangloreImageModel> imageModelArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.banglore_iv_model, null, true);
