...
class KolkataCustomeAdapter  extends BaseAdapter {

    private Context context;
    private ArrayList<KolkataImageModel> imageModelArrayList;


    public KolkataCustomeAdapter(Context context, ArrayList<KolkataImageModel> imageModelArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.kolkata_iv_model, null, true);
