...
class HyderabadCustomeAdapter  extends BaseAdapter {

    private Context context;
    private ArrayList<HyderabadImageModel> imageModelArrayList;


    public HyderabadCustomeAdapter(Context context, ArrayList<HyderabadImageModel> imageModelArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.hyderabad_iv_model, null, true);
