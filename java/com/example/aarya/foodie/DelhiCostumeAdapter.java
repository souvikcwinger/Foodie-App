...
class DelhiCustomeAdapter  extends BaseAdapter {

    private Context context;
    private ArrayList<DelhiImageModel> imageModelArrayList;


    public DelhiCustomeAdapter(Context context, ArrayList<DelhiImageModel> imageModelArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.delhi_iv_model, null, true);
