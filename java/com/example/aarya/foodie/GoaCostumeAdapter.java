...
class GoaCustomeAdapter  extends BaseAdapter {

    private Context context;
    private ArrayList<GoaImageModel> imageModelArrayList;


    public GoaCustomeAdapter(Context context, ArrayList<GoaImageModel> imageModelArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.goa_iv_model, null, true);
